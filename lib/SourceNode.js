...
var SourceNode = /*#__PURE__*/function () {
  _createClass(SourceNode, [{
    ...
    key: "className",
    get: function get() {
      return (_classPrivateFieldGet(this, _rootName) ? _classPrivateFieldGet(this, _rootName) + '__' : '') + _classPrivateFieldGet(this, _nodeName);
    }
  }, {
    key: "viewName",
    get: function get() {
  ...
  function SourceNode() {
    ...
    if (_classPrivateFieldGet(this, _rootName)) _classPrivateFieldSet(this, _nodeName, name || 'node' + _classPrivateFieldGet(this, _classId));else _classPrivateFieldSet(this, _nodeName, name || 'JSVN' + _classPrivateFieldGet(this, _classId));
  ...
  _createClass(SourceNode, [{
    ...
    value: function render() {
      ...
      if (_classPrivateFieldGet(this, _repeatFor)) {
        ...
        return (_classPrivateMethodGe2 = _classPrivateMethodGet(this, _renderOnce, _renderOnce2)).call.apply(_classPrivateMethodGe2, [this].concat(envs));
      }
    }
  }]);
    ...
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        ...
        if (child instanceof SourceNode) rendered = child.render.apply(child, envs);else if (typeof child === 'function') rendered = child.apply(void 0, envs);else if (Array.isArray(child)) {
          ...
          if (component instanceof SourceNode) rendered = component.render(props.apply(void 0, envs));else if (typeof component === 'function') rendered = component(props.apply(void 0, envs));else throw new Error("[JSVN] Unknown child type: \"".concat(_typeof(component), "\""));
        }
...
var _parseBaseItem2 = function _parseBaseItem2(baseItem, baseNode, parentData) {
  if (typeof baseItem === 'string') {
    if (baseItem.startsWith('<>')) {
      ...
      console.warn("[JSVN] Warning: node \"".concat(this.className, "\" is based on the global class \"").concat(baseItem, "\" without \"$$.import()\". The concise style of inheriting global styles is unsafe and may change in the future."));
    } else {
      if (parentData) {
        if (parentData.subclasses.includes(baseItem)) {
          _classPrivateFieldGet(this, _classes).push(_classPrivateFieldGet(this, _rootName) + '__' + baseItem);
        } else {
          _classPrivateFieldGet(this, _classes).push(parentData.baseViewName + '__' + baseItem);
        }
      } else throw new Error("[JSVN] Root node of \"".concat(this.className, "\" cannot be based on local classes, import class \"").concat(baseItem, "\" before using."));
    }
  ...
  if (baseItem) {
    if (baseItem instanceof SourceNode) {
      ...
      var _iterator4 = _createForOfIteratorHelper(_classPrivateFieldGet(baseNode, _classes)),
          _step4;

      try {
        for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
          var baseViewClass = _step4.value;
    ...
    if (baseItem === $$.__) throw new Error("[JSVN] Base node named \"".concat(_classPrivateFieldGet(this, _nodeName), "\" was not found in the parent node of the base View."));
  }
...
var _parseBases2 = function _parseBases2(bases, parentData) {
  ...
  var _iterator5 = _createForOfIteratorHelper(bases),
      _step5;

  try {
    for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
      var baseItem = _step5.value;
  ...
  if (_typeof(key) === 'object') {
    ...
    if (key.type === _symbols.default.SOURCE) {
      ...
      if (_classPrivateFieldGet(this, _children)) {
        ...
        var childNode = new SourceNode(_classPrivateFieldGet(this, _render), getCSS, value, key.base, key.name, selector, this.viewName, {
