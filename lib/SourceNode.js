...
var WARN_DYNAMIC_BASE = function WARN_DYNAMIC_BASE(className, baseItem) {
  return "[JSVN] Warning! Using a dynamic base for inheriting \"".concat(className, " : ").concat(baseItem, "\" is an experimental feature and may change in the future.");
};
...
var _parseBodyItem2 = function _parseBodyItem2(css, key, value, selector, isRootNode, subclasses, baseViewName, typeMixing) {
  if (key === '$') key = {
  ...
  if (_typeof(key) === 'object') {
    ...
    if (key.type === _symbols.default.MOD) {
      var _parser = (0, _styleParsers.default)(css, key.name, value, selector, this.viewName);

      if (_parser) {
        var classProto = key.name;

        _classPrivateFieldGet(this, _mods).push(function () {
          var _key4;

          return (_key4 = key).condition.apply(_key4, arguments) && classProto;
        });
...
var _parseContent2 = function _parseContent2(css, content, selector, isRootNode, baseViewName) {
  ...
  try {
    for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
      ...
      if (!_classPrivateMethodGet(this, _parseBodyItem, _parseBodyItem2).call(this, css, key, value, selector, isRootNode, subclasses, baseViewName, typeMixing)) {
