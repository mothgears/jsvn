  ...
  _createClass(SourceNode, [{
    ...
    value: function render(_render) {
      ...
      if (_classPrivateFieldGet(this, _repeatFor)) {
        ...
        var list = (_classPrivateFieldGet2 = _classPrivateFieldGet(this, _repeatFor)).call.apply(_classPrivateFieldGet2, [this].concat(envs));
        ...
        if (Array.isArray(list)) {
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              ...
              if (_classPrivateFieldGet(this, _condition) && !(_classPrivateFieldGet3 = _classPrivateFieldGet(this, _condition)).call.apply(_classPrivateFieldGet3, [this, itemEnv].concat(envs))) continue;
          ...
          for (var _i = 0, _Object$entries = Object.entries(list); _i < _Object$entries.length; _i++) {
            ...
            if (_classPrivateFieldGet(this, _condition) && !(_classPrivateFieldGet5 = _classPrivateFieldGet(this, _condition)).call.apply(_classPrivateFieldGet5, [this, key, value].concat(envs))) continue;
...
var _renderOnce2 = function _renderOnce2(render) {
  ...
  if (_classPrivateFieldGet(this, _envMod)) {
    ...
    if (typeof _classPrivateFieldGet(this, _envMod) === 'function') envs[0] = (_classPrivateFieldGet7 = _classPrivateFieldGet(this, _envMod)).call.apply(_classPrivateFieldGet7, [this].concat(envs));else envs[0] = _classPrivateFieldGet(this, _envMod);
  } else {
    var newEnv = null;
